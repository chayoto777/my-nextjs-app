...
<div className="relative flex justify-center items-center w-screen h-screen bg-gray-900 overflow-hidden">
  ...
  <div
    ...
    style={{
      backgroundImage: `url('/background/blueBackGround.jpg')`, // Hardcode the path as a test
    }}
  ></div>

  {/* Background Gradient Overlay */}
  <div className="absolute inset-0 bg-gradient-to-br from-purple-700 to-blue-500 opacity-70 z-10"></div> {/* Adjust opacity */}
    ...
    <form onSubmit={handleSubmit} className="space-y-6 w-full">
      <div>
        <input
          ...
          className="w-full p-4 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-4 focus:ring-blue-300 transition-shadow shadow-sm hover:shadow-lg text-black"
          required
        />
      </div>
